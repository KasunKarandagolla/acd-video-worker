...
8727e6729512ef6415768e1980b1aadc19084abe
...
- Function: get_skill_commands
- Path: /kaggle/working/acd-video-worker/external/Hermes-Agent/agent/skill_commands.py
- Scan function found: True

## V7 Skills

- Base: /kaggle/working/acd-video-worker/skills/football-emotion
- Count: 23
...
- Session ID: None
- Exit status: None
- Pipeline routing guide loaded: False
...
- Hermes AIAgent not importable from venv: Error in sitecustomize; set PYTHONVERBOSE for traceback:
