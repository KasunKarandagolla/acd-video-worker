...
Missing required artifacts (17): match_fact_lock.json, brief_interpretation.json, source_candidates.json, source_verification.json, media_probe.json...
